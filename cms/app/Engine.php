 ...
 * @method \app\template\View view() Gets current view
 *
 * Request-response
...
class Engine {
    ...
    public function init() {
        ...
        $this->loader->register('view', '\app\template\View', array(), function($view) use ($self) {
            $view->path = $self->get('sys.views.path');
            $view->cache = $self->get('sys.views.cache');
            $view->cacheTime = $self->get('sys.views.cacheTime');
            $view->extension = $self->get('sys.views.extension');
        });
